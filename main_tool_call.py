...
assistant = AssistantAgent(
    ...
    system_message=(
        "For creation of greetings, only use the functions you have been provided with."
        + "Return TERMINATE when you received the function result."
        +"You reply to call a function is as below."
        +"Example: {\"function_call\": <function calling data>}"
        # +"{\"function_call\": {\"name\": \"greeter\", \"arguments\": \"{\\\"name\\\": \\\"Alice\\\"}\"}}"
...
if __name__ == "__main__":
    prompt :str = "I want to create a greeting. The name is 'Bob'"
