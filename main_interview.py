...
assistant = ConversableAgent(
    name="Student",
    system_message="Your name is Cathy and you are meeting Joe for a python interview regarding secure coding with c#. He is a c# tech lead. Once he is done chatting, he will tell you GOODBYE, thank him and end the covo,do not continue. Do not tell him goodbye until he tells you that first.",
